...
- **[2025/7/18]** [Demo space](https://huggingface.co/spaces/lch01/StreamVGGT) and [model checkpoints](https://huggingface.co/lch01/StreamVGGT/) released on Hugging Face; demo code is also available for local launch.
